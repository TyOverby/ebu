...
class type intersectionObserverOptions =
  object
    ...
    method threshold : int Js.js_array Js.writeonly_prop
  end
...
class type intersectionObserver =
  object
    ...
    method threshold : int Js.readonly_prop
...
let intersectionObserver = Js.Unsafe.global##._IntersectionObserver
let is_supported () = Js.Optdef.test intersectionObserver
